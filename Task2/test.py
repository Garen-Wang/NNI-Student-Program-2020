...
def train(trainloader, path, args):
    global model
    ...
    model.load_state_dict(torch.load('./cifar_net4.pth'))
...
def main():
    ...
    args = {"lr": 0.0001, "model": "mobilenet", "optimizer": "Adamax"}
    for t in range(1):
        train(trainloader, path, args)
